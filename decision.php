...
$d_id = $_SESSION['decision_id'];



$result = mysql_query("select * from participate where decision_id = '".$d_id."' and user_id = '".$_GET['user']."' ");
...
<!--    <a href="almostdone.php?user_id=--><?php //echo $_GET['user']?><!--" class="button button-rounded button-raised" style="margin-left: 1050px;  margin-top: 300px; float:left">Finish</a>-->
    <a onclick="checkWord()" class="button button-rounded button-raised" style="margin-left: 1050px;  margin-top: 300px; float:left">Finish</a>
...
$result = mysql_query("select * from decision where id = '".$d_id."'");
$row = mysql_fetch_array($result);
...
//sijia's part ********************************************************************************************************
            ...
            xmlhttp.open("GET","fetch_individual_data.php?decision_id=<?php echo $d_id?>&user_id=<?php echo $_GET['user']?>",true);
        xmlhttp.send();
...
//        console.log(jsonString);
        ...
        $.ajax({
            url: "save_data.php?decision_id=<?php echo $d_id;?>&user_id=<?php echo $_GET['user'];?>",
            type: "POST",
...
//        console.log(jsonString);
        ...
        $.ajax({
            url: "save_argu.php?decision_id=<?php echo $d_id;?>&user_id=1",
            type: "POST",
            data:{trans_data:jsonString},
            traditional: true,
            error: function(){
